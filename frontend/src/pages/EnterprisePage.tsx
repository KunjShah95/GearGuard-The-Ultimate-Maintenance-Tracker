            ...
            <main className="pt-48 pb-32 px-6">
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col lg:flex-row items-end justify-between gap-12 mb-32">
                        <div className="max-w-2xl">
                            ...
                            <motion.h1
                                ...
                                className="text-6xl md:text-8xl font-display font-bold text-slate-900 tracking-tight leading-[0.9] mb-8"
                            >
                                Built for <br />
                                <span className="text-slate-400 italic">Unrivaled</span> <br />
                        ...
                        <motion.div
                            ...
                            className="bg-white border border-slate-200 shadow-xl p-8 rounded-[2rem] max-w-sm"
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-32">
                        {tiers.map((tier, i) => (
                            <motion.div
                                ...
                                className={`p-12 rounded-[3.5rem] border ${tier.featured ? 'bg-slate-900 text-white border-slate-900 shadow-2xl' : 'bg-white text-slate-900 border-slate-200 shadow-sm'} relative overflow-hidden group`}
                            >
                                {tier.featured && (
                                ...
                                <p className={`text-sm mb-12 font-bold ${tier.featured ? 'text-slate-400' : 'text-slate-500'} uppercase tracking-[0.2em]`}>{tier.desc}</p>
                                ...
                                <div className="pt-8 border-t border-current/10">
                                    ...
                                    <button className={`w-full h-16 rounded-2xl text-lg font-bold transition-all ${tier.featured ? 'bg-primary text-white hover:bg-primary-dark shadow-xl shadow-primary/20' : 'bg-slate-100 text-slate-900 hover:bg-slate-200'}`}>
                    ...
                    <div className="text-center space-y-8">
                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.5em]">Trusted by Industry Leaders</p>
                        <div className="flex flex-wrap justify-center gap-12 opacity-40 grayscale hover:grayscale-0 transition-all duration-700">
                            ...
                            <Icon icon="logos:ge-monogram" className="h-8 w-auto" />
                            <Icon icon="logos:tesla" className="h-8 w-auto" />
                            <Icon icon="logos:bosch" className="h-8 w-auto" />
                        </div>
                    </div>
                </div>
            </main>
