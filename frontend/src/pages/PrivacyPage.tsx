        ...
        <div className="min-h-screen bg-slate-50 text-slate-600 selection:bg-primary/30 font-sans">
            ...
            <div className="pt-48 pb-32 px-8 md:px-24 max-w-7xl mx-auto">
                <div className="max-w-3xl">
                    <h1 className="text-6xl font-display font-bold text-slate-900 mb-8">Privacy Protocol</h1>
                    <p className="text-slate-500 font-bold mb-12 uppercase tracking-widest leading-relaxed">// VERSION_2025_A</p>

                    <div className="space-y-12 mb-20">
                        <section>
                            <h2 className="text-xl font-bold text-slate-900 mb-4">Tactical Data Collection</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-slate-900 mb-4">Encryption Standards</h2>
                            <p className="text-slate-600 leading-relaxed font-light">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-slate-900 mb-4">Operator Rights</h2>
                            <p className="text-slate-600 leading-relaxed font-light">
