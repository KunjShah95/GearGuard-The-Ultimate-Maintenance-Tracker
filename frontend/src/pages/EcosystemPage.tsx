            ...
            <main className="pt-48 pb-32 px-6">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="relative mb-32">
                        ...
                        <div className="relative bg-white/50 backdrop-blur-xl rounded-[4rem] p-12 overflow-hidden border border-slate-200 shadow-xl flex flex-col md:flex-row items-center justify-around gap-12">
                            {ecosystemNodes.map((node, i) => (
                                ...
                                >
                                    <div className="w-20 h-20 rounded-3xl bg-white border border-slate-200 flex items-center justify-center mx-auto mb-6 shadow-lg group hover:border-primary transition-all">
                                    ...
                                    <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">{node.desc}</p>
                                </motion.div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-center md:text-left">
                        <div className="p-12 space-y-6">
                            <h2 className="text-3xl font-display font-bold text-slate-900 tracking-tight">Seamless Integration</h2>
                        ...
                        <div className="p-12 space-y-6">
                            <h2 className="text-3xl font-display font-bold text-slate-900 tracking-tight">Security-First Protocol</h2>
                            <p className="text-slate-500 font-medium leading-relaxed">
